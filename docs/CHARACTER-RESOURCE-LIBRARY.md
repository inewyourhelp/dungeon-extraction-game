...
| # | NPC 名称 | 文件路径 | 尺寸 | 表情状态 | 数量 | 优先级 |
|---|----------|----------|------|----------|------|--------|
| **19** | 铁匠凯尔 | `npcs/blacksmith_kael/` | 32x32 | neutral/happy/worried/aggressive | 4 张 | P0 |
| **20** | 药剂师艾薇拉 | `npcs/alchemist_elvira/` | 32x32 | neutral/happy/worried/aggressive | 4 张 | P0 |
| **21** | 商人罗恩 | `npcs/merchant_ron/` | 32x32 | neutral/happy/worried/aggressive | 4 张 | P0 |
| **22** | 情报员影 | `npcs/shadow_shadow/` | 32x32 | neutral/happy/worried/aggressive | 4 张 | P0 |
| **23** | 旅馆老板玛莎 | `npcs/martha_innkeeper/` | 32x32 | neutral/happy/worried/aggressive | 4 张 | P0 |
...
| 顺序 | 任务 | 预计耗时 | 输出文件数 |
|------|------|----------|------------|
| **6** | NPC 铁匠凯尔 (4 种表情) | 30min | 4 张 |
| **7** | NPC 药剂师艾薇拉 (4 种表情) | 30min | 4 张 |
| **8** | NPC 商人罗恩 (4 种表情) | 30min | 4 张 |
| **9** | NPC 情报员影 (4 种表情) | 30min | 4 张 |
| **10** | NPC 旅馆老板玛莎 (4 种表情) | 30min | 4 张 |
| **11** | Boss 熔岩巨兽 (idle/attack/death) | 2h | 16 帧 |
